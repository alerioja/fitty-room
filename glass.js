// this helper function loads the glasses atop of the user's image
...
var glassWidth=266;
var glassWidth=123;
var glassInitWidth=161;
var glassInitHeight=82;
var msgPleaseSelectGlass = 'Please select glass.';
				...
				el.addEvent('click',function(){
					...
					if(Browser.Engine.trident4){
						...
						if($chk($('glass'))){
							...
							var initLeftMargin = 131;
							var initTopMargin  = 172;
							...
							$('dragInfo').setStyle('display','hidden');
							$('sunglass-area').setStyle('display','block');
